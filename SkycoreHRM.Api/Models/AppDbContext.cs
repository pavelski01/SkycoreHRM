...
namespace SkycoreHRM.Api.Models
{
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Country>().HasData(new Country { CountryId = 10, Name = "Poland" });
            modelBuilder.Entity<Country>().HasData(new Country { CountryId = 11, Name = "Czechia" });
            modelBuilder.Entity<Country>().HasData(new Country { CountryId = 12, Name = "Ukraine" });
            modelBuilder.Entity<Country>().HasData(new Country { CountryId = 13, Name = "Russia" });
            ...
            modelBuilder.Entity<JobCategory>().HasData(new JobCategory() { JobCategoryId = 4, JobCategoryName = "Office staff" });
            ...
            modelBuilder.Entity<JobCategory>().HasData(new JobCategory() { JobCategoryId = 9, JobCategoryName = "Warehouse" });
