...
namespace SkycoreHRM.Api.Migrations
{
    ...
    [Migration("20200503141122_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SkycoreHRM.Shared.Country", 
                b =>
                {
            ...
            modelBuilder.Entity("SkycoreHRM.Shared.Employee", 
                b =>
                {
            ...
            modelBuilder.Entity("SkycoreHRM.Shared.JobCategory", 
                b =>
                {
                    b.Property<int>("JobCategoryId")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("SkycoreHRM.Shared.Employee", 
                b =>
                {
                    b.HasOne("SkycoreHRM.Shared.Country", "Country")
                        .WithMany()
                        .HasForeignKey("CountryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SkycoreHRM.Shared.JobCategory", "JobCategory")
                        .WithMany()
